...
TOFArray::TOFArray() {
    ...
    sensors = new TOFSensor[size]{
            TOFSensor(new VL53L0X(I2C_MASTER_NUM, TOF_SENSOR_DEFAULT_ADDRESS, (gpio_num_t)CONFIG_TOF0_XSHUT), 360-12),
            TOFSensor(new VL53L0X(I2C_MASTER_NUM, TOF_SENSOR_DEFAULT_ADDRESS, (gpio_num_t)CONFIG_TOF1_XSHUT), 0),
            TOFSensor(new VL53L0X(I2C_MASTER_NUM, TOF_SENSOR_DEFAULT_ADDRESS, (gpio_num_t)CONFIG_TOF2_XSHUT), 12),
            TOFSensor(new VL53L0X(I2C_MASTER_NUM, TOF_SENSOR_DEFAULT_ADDRESS, (gpio_num_t)CONFIG_TOF3_XSHUT), 90),
            TOFSensor(new VL53L0X(I2C_MASTER_NUM, TOF_SENSOR_DEFAULT_ADDRESS, (gpio_num_t)CONFIG_TOF4_XSHUT), 270)
    };
